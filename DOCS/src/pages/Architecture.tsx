  ...
  return (
    <article className="prose prose-slate prose-base md:prose-lg max-w-none">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-slate-900">1. The Backend Engine (Python / Flask)</h2>
        <p>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 md:p-6 my-8 shadow-sm">
          <h3 className="mt-0 text-xl font-bold">Why Flask over Django or FastAPI?</h3>
          <p className="mb-0 text-slate-600 text-sm md:text-base">
        ...
        <h3 className="text-xl font-bold">Intelligent Web Scraping (BeautifulSoup4)</h3>
        <p>
    ...
    ...`}</code></pre>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-slate-900">2. The Artificial Intelligence Layer (Gemini)</h2>
        <p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 my-10 not-prose">
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 md:p-6 shadow-sm">
            <h3 className="mt-0 text-lg font-bold text-slate-900 mb-2">Strict Prompt Engineering</h3>
            ...
            <div className="bg-slate-900 text-green-400 p-4 rounded-lg text-[10px] md:text-xs font-mono overflow-x-auto whitespace-nowrap shadow-inner">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 md:p-6 shadow-sm">
            <h3 className="mt-0 text-lg font-bold text-slate-900 mb-2">Regex Score Extraction</h3>
            <p className="text-xs md:text-sm text-slate-600 mb-4">
            ...
            <div className="p-4 bg-primary-50 border border-primary-100 rounded-lg">
              <code className="text-[10px] md:text-xs text-primary-700 font-bold block">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-slate-900">3. Security & Rate Limiting</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 not-prose">
          <div className="p-5 bg-white border border-slate-200 rounded-xl shadow-sm">
            <h4 className="mt-0 text-slate-900 font-bold flex items-center gap-2 mb-2">
              <span className="w-2 h-2 rounded-full bg-red-500"></span>
              Flask-Limiter
            </h4>
            <p className="text-sm text-slate-600 mb-0 leading-relaxed">We restrict requests to <code>5 per minute</code> per IP. This blocks automated bots trying to exhaust our Gemini API quota.</p>
          </div>
          <div className="p-5 bg-white border border-slate-200 rounded-xl shadow-sm">
            <h4 className="mt-0 text-slate-900 font-bold flex items-center gap-2 mb-2">
            ...
            <p className="text-sm text-slate-600 mb-0 leading-relaxed">A static bearer token is injected into headers by the extension, providing a barrier against unauthorized API discovery.</p>
          </div>
        </div>
      </section>

      <section className="mb-12">
        <h2 className="text-2xl font-bold text-slate-900">4. The Client (React Extension)</h2>
        <p>
